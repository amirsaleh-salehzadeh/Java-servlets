...
<td width="770" valign="top">
    ...
    <a href="shop.html">Shop</a> | <a href="contact us.html">Contact us</a> | <a href="register.jsp">Register</a> | <a href="advanced_search.jsp">Advanced Search </a></td> 
    </tr>
    </table>
    ...
    <td width="525" align="left" valign="top"><p>&nbsp;</p>
    
    <%
    String message="";
    if(request.getAttribute("message")!=null)
        message="<font color=red> <center>"+(String)request.getAttribute("message")+"</center></font><BR>";
    %>    
      <label>
          <%=message%>
      </label>
