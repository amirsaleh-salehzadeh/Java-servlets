...
<BODY background="img/bg.gif" bgcolor="#202020" topmargin="0" leftmargin="0">
    ...
    <form name="form1" id="form1" onSubmit="return check();" method="post" action="RegServlet?action=updateProfile">
...
<td width="770" valign="top">
    ...
    <tr>
    <td height="32" align="left" valign="middle" background="img/bluebg.gif"><img src="img/pixel.gif" border="0" width="15" height="1"><a href="home.php">
    Home</a> | <a href="shop.html">Shop</a> | <a href="contact us.html">Contact us</a> | <a href="advanced_search.html">Advanced Search </a> | <a href="LoginServlet?action=logout">Logout</a></td> 
    </tr>
    </table>
    ...
    <td width="525" align="left" valign="top"><img src="img/shadow1.gif" border="0" width="525" height="32"><br>
      <p align="center">
        <label>Name
        <input type="text" name="name" id="name" value="<%=result.getString("name")%>">
        </label>
      </p>
      <p align="center">
        <label>Family Name
        <input type="text" name="family" id="family" value="<%=result.getString("fname")%>">
        </label>
      </p>
      <p align="center">
        <label>Username
        <input readonly type="text" name="username" id="username" value="<%=result.getString("username")%>">
        </label>
      </p>
      <p align="center">
        <label>Password
        <input type="password" name="password" id="password" value="<%=result.getString("password")%>">
        </label>
      </p>
      <p align="center">
        <label>Address
        <input type="text" name="address" id="address" value="<%=result.getString("address")%>">
        </label>
      </p>
      <p align="center">
        <label>Tel
      ...
      <p align="center">
        <label>Email
        <input type="text" name="email" id="email" value="<%=result.getString("email")%>">
        </label>
      </p>
      <p align="center"><input type="submit" name="submit" id="button" value="Update">&nbsp;</p>
      <p align="center">&nbsp;</p></td>  
    <td width="10" align="left" valign="top"><img src="img/shadow1.gif" border="0" width="10" height="32"></td> 
    </tr>
    </table> 
