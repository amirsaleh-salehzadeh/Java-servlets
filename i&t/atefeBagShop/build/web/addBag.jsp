             ...
             <td colspan="6" background="images/burberry-check.jpg">
                 <form action="addBag" method="post">
                    <table align="center"> 
                        ...
                        <tr>
                            <td align="center">
                                <span class="title">Add a Bag</span>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
<table width="324" border="1">
  ...
  <tr>
    ...
    <td class="content"><input name="description" type="text"></td>
  </tr>
  <tr>

    <td class="content">Price:</td>
    <td class="content"><input name="price" type="text"></td>
  </tr>
  <tr>
    <td class="content">Image:</td>
    <td class="content"><input name="img" type="password"></td>
  </tr>
  <tr>
