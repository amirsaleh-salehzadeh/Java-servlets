						...
						<table align="center" >
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                           ...
                                                           for (int i = 0; i<al.size(); i++){
                                                               x =i+1;
                                                               out.print("<tr><td><span class=\"rowId\">"+x+"th Item </span></td><td align=\"center\"><img src=\"images/dvd/");
                                                               out.print(al.get(i).getImage());
                                                               out.print(".jpg\" width=\"80\" height=\"120\"/></td><td><span class=\"title\">");                                                                                                                             
                                                               out.print(al.get(i).getName());
                                                               out.print("</span><input type=\"hidden\" value=\""+ al.get(i).getName() +"\" name=\"dvdName\"/></td></tr>");
                                                           }
                                                           double y = x * 29.99; 
                                                           out.print("<tr><td colspan=\"4\"><span class=\"price\">Total Price is: "+y+" $</span></td></tr>");
                                                            %>
                                                        </table>
                                            ...
                                            <tr>
                                                <td>
                                                 ...
                                                 out.print("<input type=\"hidden\" value=\""+y+"\" name=\"price\">");  
                                                 
                                                 out.print("<input type=\"hidden\" value=\""+users.get(0).getUserName()+"\" name=\"userName\">");  
                                                 %>
                                                        <input type="submit" value="Confirm Purchase">
                                                    </form>
                                                    <form action="clearBasket" method="get">
