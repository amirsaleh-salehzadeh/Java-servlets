...
<table bgcolor="#02263d" id="Table_01" width="800" height="267" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td colspan="6" >
                 <table>
                 <tr>
                     <td width="30%" align="center" bgcolor="#074065" style="color:#fff;" valign="top">
                 <span style="color:#ff0000; font-size:18px; font-weight:bold;">
                    ...
                    %> <br/>                                                                                 
                     ...
                     <td width="" style="color:#fff;" valign="top" background="images/bg_1.jpg">sdfgsdfgsd<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>fg sfdg
                     </td>
