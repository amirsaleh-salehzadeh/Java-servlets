    ...
    */
    ...
    throws ServletException, IOException {
       ...
       try{
           ...
           if(!"".equalsIgnoreCase(request.getParameter("search")) && "search".equalsIgnoreCase(request.getParameter("toSearch")) ){
               piano = bs.searchForPiano(request.getParameter("search"));
               pianos.add(piano);
           } else {
                pianos = bs.allPianos();
           }
