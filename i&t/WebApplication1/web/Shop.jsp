  ...
  <tr>
    <td ><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="100%" valign="top"><div align="right" class="style7"><a href="Logout">
		...
		<%
        ArrayList<User> u=(ArrayList<User>)session.getAttribute("login");
        if(session.getAttribute("login")!=null){
        for(int j=0;j<u.size();j++){                         
           out.println("<span class=\"style9\">Welcome "+u.get(j).getName()+" "+ u.get(j).getFname()+"!</span>");
            }}
                 %>      
...
<%
        ...
        ArrayList<Product> t=(ArrayList<Product>)session.getAttribute("productlist");
        ...
        {                         
            ...
            out.println("<td valign=\"bottom\" width=\"120\">");
              if(session.getAttribute("login")!=null){
            out.print("<form name=\"\" method=\"post\" action=\"AddToB\"><input type=\"hidden\" name=\"textfield\" id=\"textfield\" value=\"");
            out.print(t.get(i).getPname());
            out.println("\">");
            out.println("<input type=\"submit\" name=\"button\" id=\"button\" value=\"Add To Basket\">");
            out.println("</form>");
            }
            out.println("</td></tr>");
...
%>
<tr><td><form action="BasketView" method ="post">
<input type="submit" name="submit" value="Order View">                 
</form></table>
