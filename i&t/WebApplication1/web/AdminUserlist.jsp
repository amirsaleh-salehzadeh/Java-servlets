...
<form action="AdminSelect" method="post"><table width="459" border="1">
  <tr>
    <td width="39"><span class="style4">Name</span></td>
    <td width="87"><span class="style4">Family Name</span></td>
    <td width="35"><span class="style4">Email</span></td>
    <td width="67"><span class="style4">Telephone</span></td>
    <td width="75"><span class="style4">User Name</span></td>
    <td width="64"><span class="style4">Password</span></td>
    <td width="46"><span class="style4">Administrator</span></td>
    <td width="46"><span class="style4">Delete</span></td>
  </tr>
    <span class="style6">
    <%
        ArrayList<User> t=(ArrayList<User>)session.getAttribute("usercontrol");
        for(int j=0;j<t.size();j++){                         
            out.println("<tr><td><span class=\"style6\">");
            out.println(t.get(j).getName());
            out.println("</span></td><td><span class=\"style6\">");
            out.println(t.get(j).getFname());
            out.println("</span></td><td><span class=\"style6\">");
            out.println(t.get(j).getEmail());
            out.println("</span></td><td><span class=\"style6\">");
            out.println(t.get(j).getTel());
            out.println("</span></td><td><span class=\"style6\">");
            out.println(t.get(j).getUsern());
            out.println("</span></td><td><span class=\"style6\">");
            out.println(t.get(j).getPass());
            out.println("</span></td> ");
            if(t.get(j).getAccess().equals("admin")){
                out.println("<td align=\"center\"><span class=\"style6\"><label>Admin</label></span>");
                }
            else{                
                out.print("<td align=\"center\"><input type=\"checkbox\" name=\"checkbox\" value=\"");
                out.print(t.get(j).getUsern());                
                out.print("\"/></td>");
                }
                out.print("<td align=\"center\"><input type=\"checkbox\" name=\"delete\" value=\"");
                out.print(t.get(j).getUsern());                
                out.print("\"/></td></tr>");
