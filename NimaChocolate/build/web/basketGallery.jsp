                                          ...
                                          <%  
                                            ...
                                            <tr>
                                                <td bgcolor="#328712">
                                                     ...
                                                     <img style="cursor: pointer;" src="images/addChocolate.jpg"></a>
                                                 </td>
                                            </tr>
                                            <%}
                                                }}
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <table width="450" border="1" >
                                                        ...
                                                        <form action="confirmPurchase" method="post">
                                                            <td align="center">
                                                             <%
                                                                 ...
                                                                 out.print("Mr/Mrs. ");
                                                                 out.print("<Span style=\"color: #257898;\">");
                                                                 out.print(user.get(0).getName());
                                                                 out.print(" "+ user.get(0).getFamilyName());
                                                                 out.print("</Span>");
                                                                 
                                                             %>           Your Basket contains:
                                                             <input type="hidden" value="<%=user.get(0).getName()%>" name="name">
                                                             <input type="hidden" value="<%=user.get(0).getFamilyName()%>" name="Fname">    
                                                            </td>
                                                            <td nowrap="nowrap">
                                                                choose to confirm
                                                            </td>                                                            
                                                        ...
                                                        <%
	                                                         ArrayList<Chocolate> arrayList =(ArrayList<Chocolate>)session.getAttribute("basketSession");
                                                            
                                                            for(int i = 0; i < arrayList.size(); i++)
                                                            {     
                                                                int x = i+1;                
                                                                int p = i;
                                                                out.println("<tr><td><p class=\"title\">Item " + x + ":</p>");
                                                                out.println("<p class=\"titleForm\">");
                                                                out.println(arrayList.get(i).getChocolateName());
                                                                out.println("</p></td><td align=\"center\">");
                                                                %>
                                                                <input type="checkbox" name="product" value="<%=arrayList.get(i).getChocolateName()%>" checked="checked"/>
