				...
				<tr>
                                    <td class="contentTable" align="center">
                                        <table>
                                            ...
                                            <tr>
                                                <td bgcolor="#328712">
                                                     <a target="_blank" href="addBrand.html" style="text-decoration: none;">
                                                     <img style="cursor: pointer;" src="images/addBrand.bmp"></a>
                                                 </td>
                                            </tr>
                                            <%}
                                                }}
                                            ...
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <%
                                                            ...
                                                            {                         
                                                                out.println("<tr><td align=\"center\" width=\"120\" ><a href=\"productsView?brandName="); 
                                                                out.println(arrayList.get(i).getBrandName());
                                                                out.println("\"><img src=\"images/brands/");
                                                                out.println(arrayList.get(i).getBrandImageAddress());
                                                                out.println("\"></a></td><tr></tr><tr><td><p class=\"title\">Producer Name:</p><p class=\"titleForm\">");
                                                                out.println(arrayList.get(i).getBrandName());
                                                                out.println("</p><p><span class=\"title\">Description:</span></p><pz>");
                                                                out.println(arrayList.get(i).getBrandDescription());
                                                                out.println("</p>");
                                                                out.println("</td></tr>");
