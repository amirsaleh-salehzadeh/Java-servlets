          ...
          <table width="100%" border="0" cellpadding="5" cellspacing="5">
            <tr>
              <td><table width="87%" border="0" align="center" cellpadding="3" cellspacing="3">
                  <%
                    ArrayList<auctionENT> aulist = (ArrayList<auctionENT>) session.getAttribute("auctionlist");
                    for(int i = 0; i < aulist.size(); i++) {
                  %>
              <tr>
                <td style="font-size:14px"><strong><a href="DetailAuctionServlet?id=<%= aulist.get(i).getAuction_id() %>"><%= aulist.get(i).getTitle() %></a></strong></td>
              </tr>
              <tr>
                <td><table width="100%" border="0">
                  <tr>
                    <td>End Date: <%= aulist.get(i).getEndDate() %></td>
                  </tr>
                  <tr>
                    <td><strong>Base Price: <%=aulist.get(i).getBasePrice()%></td>
                  </tr>
                </table></td>
              </tr>
              <% } %>
