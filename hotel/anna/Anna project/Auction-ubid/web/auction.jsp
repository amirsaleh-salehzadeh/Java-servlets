  ...
  <tr>
    <td height="634" colspan="2" background="images/bkg.jpg" valign="top">
      ...
      <tr>
        ...
        <tr>
            <td><% if(auctionlist.get(i).isIsActive()==0){%>
            
            Not confirmed:
            
            <a href="auctionauthServlet?task=accept&id=<%= auctionlist.get(i).getAuction_id()%>">Accept</a>
            <a href="auctionauthServlet?task=deny&id=<%=auctionlist.get(i).getAuction_id() %>">Deny</a>
            <% } else if(auctionlist.get(i).isIsActive()==1){%>
            Accept:<a href="auctionauthServlet?task=deny&id=<%=auctionlist.get(i).getAuction_id()%>">Deny</a>
            Deny:<a href="auctionauthServlet?task=accept&id=<%=auctionlist.get(i).getAuction_id()%>">Accept</a>
                    </td>
                    <td><a href="detailAuctionServlet?id=<%= auctionlist.get(i).getAuction_id() %>">Detail</a></td>
           </tr>
