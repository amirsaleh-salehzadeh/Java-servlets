...
<table bgcolor="#02263d" id="Table_01" width="800" height="267" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
                    <form action="confirmPurchase" method="post">
                        <td colspan="6" bgcolor="#02263d" background="images/bg_1.jpg" align="center">
                     <span style="font-weight:bold; font-size:18px; color:#fff;">Mr/Mrs <%=user.getName()%> <%=user.getFamilyName()%> Your basket contains:</span>
                    <table width="600" align="center" style="color:#fff;" >
                       <%
                           ...
                           for (int i = 0; i<arrayList.size(); i++){
                               ...
                               out.print("<a href=\"addToB?reqCode=remove&productName="+ arrayList.get(i).getProductName()+"\" /><img src=\"images/remove.jpg\"></a>");
                               out.print("</td></tr>");
