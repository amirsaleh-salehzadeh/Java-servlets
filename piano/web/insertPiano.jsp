...
<table bgcolor="#02263d" id="Table_01" width="800" height="267" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td colspan="6" background="images/bg_1.jpg" align="center">
             <span style="color:#ff0000; font-size:18px; font-weight:bold;">
                    ...
                    <form id="form1" name="form1" method="post" action="insertPiano">
                        ...
                        <table style="color:#fff;">
                          ...
                          <tr>
                            <td colspan="2" align="center">
                                <%if(user.isSecurity()){%>
                                    <input type="submit" name="Submit" value="Add Piano" />
                                <%}%>
                            </td>
                          </tr>
                        </table>
